...
export default function Contact() {
    return (
        <section id='contact' className='container-fluid text-light vh-100 d-flex justify-content-center align-items-center flex-column gap-3'
            style={{ backgroundColor: 'black' }}>
            <h1 className='mb-5'>Contact me</h1>
            <div className='container-fluid d-flex px-5 gap-5'>
                <div className='w-50 d-flex flex-column justify-content-center px-5 gap-3'>
                    <h3 style={{
